(() => {
  ...
  const URL_APPS_SCRIPT =
    "https://script.google.com/macros/s/AKfycbzhvitn5H4nxQJw2PI-KHtSzkwQFng1God3sknL-xh8jX_bh8pClBnJOsQ0rmQLWupC/exec";
    ...
    try {
      const response = await fetch(URL_APPS_SCRIPT, {
        ...
        body: JSON.stringify({
          ...
          fecha_con_end: fechaConsul + " " + "23:59:00",
        }),
      });
  ...
  function handleSubmitPrediccion() {
    ...
    let data = {
      ...
      Numero: _cedula_result_.textContent,
  ...
  function getDataPredi() {
    ...
    fetch(
      `${URL_APPS_SCRIPT}?hoja=event&numero=${_cedula_result_.textContent}&token=${token}`,
    )
      .then((res) => res.json())
      .then((data) => {
